...
public class UserInterface {
    ...
    public BGCommander command() {return commander;}//Need access to commander in other classes.
    ...
    */
    public void launch(){
		try {
			...
			//Does this make more sense, compared to the original one? I am just trying to delete redundant codes.
			this.returnFrame().setVisible(true);
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
